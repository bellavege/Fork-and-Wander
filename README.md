    ...
    <section id="recipes">
        ...
        <div class="recipe">
            ...
            <div class="recipe-content">
                ...
                <h4>Instructions:</h4>
                <p>Grill the eggplant slices over medium heat until tender. In a small bowl, mix the olive oil, salt, pepper, garlic, parsley, and lemon juice. Drizzle over the grilled eggplant and serve.</p>
            </div>
        </div>
        <div class="recipe">
            ...
            <div class="recipe-content">
                <h4>Ingredients:</h4>
                <ul>
                    <li>2 large eggplants, sliced</li>
                    <li>1 cup breadcrumbs</li>
                    <li>1/2 cup vegan Parmesan</li>
                    <li>2 cups marinara sauce</li>
                    <li>1 cup vegan mozzarella</li>
                </ul>
                <h4>Instructions:</h4>
                <p>Bake the eggplant slices until golden. Layer with breadcrumbs, vegan Parmesan, marinara sauce, and vegan mozzarella in a baking dish. Bake at 375°F (190°C) for 20 minutes until bubbly and golden.</p>
            </div>
        </div>
        <div class="recipe">
            <h3>Baba Ganoush</h3>
            <div class="recipe-content">
                ...
                <h4>Instructions:</h4>
                <p>Roast the eggplant until tender. Peel and blend with garlic, tahini, lemon juice, olive oil, and salt until smooth. Serve with pita bread.</p>
            </div>
        </div>
        <div class="recipe">
            <h3>Szechuan Spicy Eggplant</h3>
            <div class="recipe-content">
                <h4>Ingredients:</h4>
                <ul>
